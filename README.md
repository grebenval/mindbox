...
1. **MindboxApi** - 45%, покрыт контроллер (при сильном желании можно 100%, но трата времени? Целесообразность?)
2. **Mindbox.Bl** - 100%.
3. **Mindbox.Database.Sqlite** - 93.88%, покрыты классы для манипуляции данных (всё, что генерируется не покрыто, можно и это покрыть, но трата времени? Целесообразность?)
...
* ***Расширить*** интерфейс новый к ***IFigureManipulation*** или ***создать дополнительный*** для взаимодействия с БД
...
метод ***Create()***, расширить массив ***_validatorsFigures*** на метод валидации созданный в созданном классе фигуры, и реализовать вызов валидации в
методе ***Validate***
